  ...
  <body>
	...
	<div id="carousel-id" class="carousel slide" data-ride="carousel" style="margin-top: -23px;">
			...
			<div class="carousel-inner">
				<div class="item">
					<img data-src="holder.js/900x500/auto/#777:#7a7a7a/text:First slide" alt="First slide" src="{{asset( 'img/pic/tips-on-how-to-make-a-board-game.jpeg' )}}" align="center">
					<div class="container">
				...
				<div class="item">
					...
					<div class="container">
						<div class="carousel-caption">
							...
							<p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
							<p><a class="btn btn-warning btn-lg" href="#" role="button">Browse gallery</a></p>
						</div>
					</div>
				</div>
			</div>
